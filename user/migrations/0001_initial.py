    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "read_authority",
                    models.IntegerField(default=1, verbose_name="읽기 권한"),
                ),
                (
                    "write_authority",
                    models.IntegerField(default=0, verbose_name="작성 권한"),
                ),
                (
                    "avatar",
                    models.ImageField(
                        blank=True, null=True, upload_to="avatars/", verbose_name="아바타"
                    ),
                ),
                (
                    "user_category",
